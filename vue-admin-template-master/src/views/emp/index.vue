    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" label="职位">
          <template slot-scope="scope">
            <span style="margin-right: 10px" v-if="scope.row.job == 1">流浪者</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 2">街头小子</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 3">公司员工</span>
            <span style="margin-right: 10px" v-if="scope.row.job == 4">军用科技</span>
          </template>
        </el-table-column>
